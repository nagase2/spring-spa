...
public class App implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		//ページング処理
		Pageable pageable = new PageRequest(2, 3); //ページ数、1ページあたりのページ数
		Page<Customer> page = customerRepository.findAllOrderByName2(pageable);//指定したページのデータを取得
		
		System.out.println("1ページあたりのページ数"+page.getSize());
		...
		// Integer.class); //クエリの実行結果をオブジェクトに変換して取得。返り値が一件でない場合は、Exception が返される
